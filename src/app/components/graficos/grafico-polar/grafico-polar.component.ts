...
export class GraficoPolarComponent implements OnInit {
  ...
  inicializarGraficoELegenda() {
    this.dataset = [{
      ...
      hoverBackgroundColor: ['rgba(226,0,122, 1)', 'rgba(203,211,0,1)', 'rgba(98,33,129,1)', 'rgba(0,148,196,1)', 'rgba(104,200,222,1)','rgba(165,175,35,1)','rgba(235,94,129,1)','rgba(188,9,0,1)','rgba(137,116,114,1)','rgba(55,242,183,1)'],
      borderColor: ['rgba(226,0,122, 1)', 'rgba(203,211,0,1)', 'rgba(98,33,129,1)', 'rgba(0,148,196,1)', 'rgba(104,200,222,1)','rgba(165,175,35,1)','rgba(235,94,129,1)','rgba(188,9,0,1)','rgba(137,116,114,1)','rgba(55,242,183,1)'],
      hoverBorderColor: ['rgba(226,0,122, 1)', 'rgba(203,211,0,1)', 'rgba(98,33,129,1)', 'rgba(0,148,196,1)', 'rgba(104,200,222,1)','rgba(165,175,35,1)','rgba(235,94,129,1)','rgba(188,9,0,1)','rgba(137,116,114,1)','rgba(55,242,183,1)'],
      data: [152,124,145,654,434,148,161,716,632, 154]
    }]
